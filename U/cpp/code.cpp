...
Так,
    1) мы не можем ставить откр. круглых скобок больше чем всего допустимо открывающихся минус 
        сколько уже поставили открыв. квадратных скобок.
    2) мы не можем ставить откр. квадратных скобок больше чем всего допустимо открывающихся минус 
        сколько уже поставили открыв. круглых скобок.
    ...
    Дополнительно
    5) если мы ставим открыв. круглую скобку, то последняя не должна быть открыв. квадратная, 
        иначе допустима вложенность круглых в квадратные, что запрещено по усл.
    6) если мы ставим открыв. круглую скобку, то количество открытых квадрат. скобок должно равняться количеству 
        закрытых квадрат. скобок, иначе ЗА текущей круглой скобкой (которую хотим поставить) 
        количество закрыв. квадратных скобок будет больше чем количество открыв. квадратных скобок, что вообще не является ПСП
    7) если мы ставим закрыв. круглую скобку, то количество открытых квадрат. скобок должно равняться 
        количеству закрытых квадрат. скобок, ииначе допустима вложенность круглых в квадратные, что запрещено по усл.
    8) если мы ставим закрыв. квадратную скобку, то последняя не должна быть закрыв. круглая, 
        иначе допустима вложенность круглых в квадратные, что запрещено по усл.
*/
